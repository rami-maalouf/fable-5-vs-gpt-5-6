...
5. **Delegate Exploration:** Use subagents to explore and dump files, returning only the conclusion to the main context. You can use the delegate-cheaper-subagents skill.
...
8. Do not output base64 strings to the terminal.
