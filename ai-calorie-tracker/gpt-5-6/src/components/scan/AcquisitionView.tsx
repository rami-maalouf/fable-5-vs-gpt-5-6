      ...
      <View style={styles.topBar}>
        <Pressable
          ...
          <View
            ...
            style={[styles.closeLine, styles.closeLineLeft, { backgroundColor: theme.text }]}
          />
          <View
            accessibilityElementsHidden
            style={[styles.closeLine, styles.closeLineRight, { backgroundColor: theme.text }]}
          />
        </Pressable>
      </View>

      <View style={styles.copy}>
        <Text style={[styles.eyebrow, { color: theme.coral }]}>FOOD SCAN</Text>
        <Text style={[styles.title, { color: theme.text }]}>What are you eating?</Text>
      ...
      <View style={styles.choices}>
        <Pressable
          ...
          <View style={styles.choiceIcon}>
            <View style={[styles.photoMountain, { borderColor: theme.onAccent }]} />
            <View style={[styles.photoSun, { backgroundColor: theme.onAccent }]} />
          </View>
          <View style={styles.choiceCopy}>
            <Text style={[styles.choiceTitle, { color: theme.onAccent }]}>Photos</Text>
            <Text style={[styles.choiceSubtitle, { color: theme.onAccent }]}>Choose a meal photo</Text>
          </View>
