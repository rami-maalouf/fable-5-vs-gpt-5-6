...
- greetings (`Utils/SleepGreetings.swift`): 9 time-bucketed banks (early morning
  11, morning 5, afternoon 9, evening 12, night 10, hour-before-sleep 11,
  hour-after-wake 10, should-be-sleeping 10, currently-sleeping 10 - counts of
  ACTIVE entries re-audited against source during the port; several entries are
  commented out in the swift file) with selection logic: sleeping -> sleeping bank; within 60min before bed -> before bank; within
